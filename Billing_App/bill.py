...
class Bill_App:
    def __init__(self, root ): #root : windows name
        self.root = root
        #Set the window size
        ...
        bg_color="#074463"
        title=Label(self.root, text="Super Market Billing Software",bd=12, relief=GROOVE, bg=bg_color, fg="white", font=("times new roman", 30, "bold"), pady=2).pack(fill=X)
...
#==================== Customer Detail Frame ============================================================================================================================================================
        ...
        #EntryFeild for Customer Name
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font="arial 15", bd=7, relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

         #Lable for Customer Name
        cphn_lbl=Label(F1, text="Customer Phone No.", font=( "times new roman", 18, "bold"), bg=bg_color, fg="white").grid(row=0, column=2, padx=20, pady=5)

        #EntryFeild for Customer Name
        cphn_txt = Entry(F1, width=15, textvariable=self.c_phon, font="arial 15", bd=7, relief=SUNKEN).grid(row=0, column=3, padx=10, pady=10)
        ...
        #EntryFeild for Customer Name
        c_bill_txt = Entry(F1, width=15, textvariable=self.search_bill, font="arial 15", bd=7, relief=SUNKEN).grid(row=0, column=5, padx=10, pady=10)
...
# ================================ Cosmetics frame ==========================================================================================================================================
        ...
        #Lable for Customer Name
        bath_lbl=Label(F2, text="Bathing Soap", font=( "times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        ...
        Face_cream_txt=Entry(F2, width=10, textvariable=self.face_creame, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)
        ...
        HairSpray_txt=Entry(F2, width=10, textvariable=self.spray, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)
        ...
        HairGel_txt=Entry(F2, width=10, textvariable=self.gell, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)

        bodyLotion_lbl=Label(F2, text="Body Lotion", font=( "times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        bath_txt=Entry(F2, width=10, textvariable=self.lotion, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)
...
# ================================ Cold Drink frame ==========================================================================================================================================
        ...
        Facewash_txt=Entry(F4, width=10, textvariable=self.frooti, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        thumbsup_lbl=Label(F4, text="Thumbs Up", font=( "times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        HairSpray_txt=Entry(F4, width=10, textvariable=self.thumbsup, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)
        ...
        sprite_txt=Entry(F4, width=10, textvariable=self.sprite, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)
...
# ================= Button Frame ======================
    ...
    def total(self):
        ...
        self.cosmetic_tax.set("Rs. "+str(round((self.c_tax))))
    ...
    def welcome_bill(self):
        ...
        self.textarea.insert(END, "       Welcome Webstore Details\n")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get=="":
            ...
            if self.gell.get()!=0:
                self.textarea.insert(END, f"\n Hair Gell\t\t{self.gell.get()}\t\t{self.c_hs_p}")
            ...
            if self.tea.get()!=0:
                self.textarea.insert(END, f"\n Body Lotiont\t\t{self.tea.get()}\t\t{self.g_t_p}")
...
#===================== Saving the bill in the form of a text file ==============================================
    ...
    def save_bill(self):
        ...
        if op > 0:
            ...
            f1.close()
            messagebox.showinfo("Saved", "Bill no. : "+str(self.bill_no.get())+" saved successfully")
        else:
            return
...
#==================== Clear the data through clear button ========================================
...
#============ Exit the App through exit button ===============================
...
#calling windows through mainloop
root.mainloop() 
